/*
    ...
    2. 데이터 정의어
    3. 데이터베이스 객체(user,table,sequence,view,index 등)를 생성/수정/삭제 하는 언어이다.
...
/*
    ...
    3. 칼럼 수정   : ALTER TABLE 테이블명  MODIFY        칼럼명 데이터 타입 [제약조건]
...
ALTER TABLE CUSTOMER_TBL
    MODIFY CUST_NAME VARCHAR2(30 BYTE) NULL; -- NULL 명시를 반드시 해야한다.
